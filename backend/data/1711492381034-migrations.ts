...
export class Migrations1711492381034 implements MigrationInterface {
    name = 'Migrations1711492381034'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "map" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar, "description" varchar, "pictureUrl" varchar NOT NULL, "scenarioId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_map" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar, "description" varchar, "pictureUrl" varchar NOT NULL, "scenarioId" integer, CONSTRAINT "FK_ffdf2cd8825854299677c9abf04" FOREIGN KEY ("scenarioId") REFERENCES "scenario" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_map"("id", "title", "description", "pictureUrl", "scenarioId") SELECT "id", "title", "description", "pictureUrl", "scenarioId" FROM "map"`);
        await queryRunner.query(`DROP TABLE "map"`);
        await queryRunner.query(`ALTER TABLE "temporary_map" RENAME TO "map"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_61801e51aace868cc0bd79bbca" ON "scenario_npcs_character" ("characterId") `);
        await queryRunner.query(`CREATE INDEX "IDX_dcde8f101b1fe789cf93713bca" ON "scenario_npcs_character" ("scenarioId") `);
        await queryRunner.query(`ALTER TABLE "map" RENAME TO "temporary_map"`);
        await queryRunner.query(`CREATE TABLE "map" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar, "description" varchar, "pictureUrl" varchar NOT NULL, "scenarioId" integer)`);
        await queryRunner.query(`INSERT INTO "map"("id", "title", "description", "pictureUrl", "scenarioId") SELECT "id", "title", "description", "pictureUrl", "scenarioId" FROM "temporary_map"`);
        await queryRunner.query(`DROP TABLE "temporary_map"`);
